...
При ознакомлении с заданием и openapi, столкнулся с тем, что мало ошибок проверяется и ситуаций, были добавлены другие статусы ошибок и для этого был сделан сваггер, который открывается по адресу http://localhost:8080/swagger/index.html после того как запустите сервер  
